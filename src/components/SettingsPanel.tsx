...
const GROUPS: GroupDef[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'buildStep', label: 'Minimum build step', unit: 'mi', min: 0.5, max: 4, step: 0.5,
        info: 'The smallest normal build-week increase. If your peak target is farther away, the engine may build faster toward it, but only within safety caps.' },
