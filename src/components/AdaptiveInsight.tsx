...
// Shows how the plan is personalizing to the runner's own response. Transparent
// and motivating, and honest about the one direction it moves: it can only ease
// the build, never push past the population-capped rate. Display + reasons only.
  ...
  return (
    <section data-block="adaptive" className="card !rounded-2xl px-[18px] py-4 flex flex-col gap-3">
      <div className="flex items-baseline justify-between gap-2.5">
        ...
        <span className="text-[11px] text-slate-700">personalized to you</span>
      </div>
